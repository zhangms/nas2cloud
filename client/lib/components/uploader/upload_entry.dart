...
class UploadEntry {
  ...
  @override
  String toString() {
    return 'UploadEntry(id: $id, src: $src, dest: $dest, size: $size, lastModified: $lastModified, createTime: $createTime, beginUploadTime: $beginUploadTime, endUploadTime: $endUploadTime, status: $status, message: $message)';
  }
